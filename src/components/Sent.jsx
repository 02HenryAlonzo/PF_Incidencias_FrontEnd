...
const Sent = () => {
  ...
  return (
    <>
      <h2 className="text-2xl font-bold text-indigo-600 relative top-10 pl-20 ">
        Mis Incidencias
      </h2>
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex justify-evenly items-center mt-4">
                <FaEdit className="text-blue-500 text-2xl cursor-pointer hover:text-blue-600 transition-colors" />
                <FaTrash className="text-red-500 text-2xl cursor-pointer hover:text-red-600 transition-colors" />
              </div>
            </div>
          </div>
        ))}
